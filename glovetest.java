...
public class GloveRawSentenceExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        log.info("Load data....");
        ClassPathResource resource = new ClassPathResource("/experience/experience.txt");
        ...
        double sim = vec.similarity("friend", "people");
        log.info("Similarity between people and friend: " + sim);
        Collection<String> similar = vec.wordsNearest("experience",20);
        log.info("Similar words to 'experience' : " + similar);
